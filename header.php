	...
	<header id="masthead" class="site-header">
		<!--header-->
				<div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed site-primary">
						<!-- TODO: P2 Put this header into its own template or customizable template-->
						...
						<ul class="pure-menu-list pure-u-sm-1 pure-u-12-24 pure-u-md-12-24" style="vertical-align:middle"><?php do_action('nateserk_techy_news_action_setup_menu', 'menu-header'); ?>
						</ul><!-- menu -->
